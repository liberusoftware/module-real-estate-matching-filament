...
> This optional Filament 5 presentation package presents exactly one independent domain module. It contributes reusable resources, pages, widgets, schemas, tables, infolists, and actions to application-owned panels while delegating authorization, validation, tenancy, persistence, and business rules to the real-estate-matching public boundary. It mu
...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-real-estate-matching-filament?sort=semver)](https://github.com/liberusoftware/module-real-estate-matching-filament/releases/latest) [![Tests](https://github.com/liberusoftware/module-real-estate-matching-filament/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-real-estate-matching-filament/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-real-estate-matching-filament
```
...
<a href="https://github.com/liberusoftware/module-real-estate-matching-filament/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-real-estate-matching-filament" alt="Contributors to liberusoftware/module-real-estate-matching-filament">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-real-estate-matching-filament/graphs/contributors).
